...
const optionsForFormType: CreateAxiosDefaults = {
	baseURL: process.env.NEXT_PUBLIC_API_URL,
	headers: {
...
const axiosClassicWithFormType = axios.create(optionsForFormType)
...
export { axiosClassic, axiosWithAuth, axiosWithFormType, axiosClassicWithFormType }
